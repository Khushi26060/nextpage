...
const cta_content ={ 
     ...
     description: <>From web and mobile app development to cloud integration and AI-driven automation,<br />our team ensures top-tier quality and seamless user experience. </>,
