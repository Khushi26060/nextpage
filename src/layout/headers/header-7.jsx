                    ...
                    <div className="container-fluid">
                        <div className="row align-items-center">
                            ...
                            <div className="col-6 text-end">
                                <div className="header-signin-bar tp-menu-bar">
                            ...
                            <div className="col-xxl-3 col-xl-3 col-lg-3 col-md-8 col-6">
                                <div className="header-bottom__right d-flex align-items-center justify-content-end">
                                    ...
                                    <div className="header-bottom__btn d-flex align-items-center">
                                        <Link className="tp-btn-yellow d-none d-md-inline-block inner-color" href="/contact">
                                            Get in Touch
                                        </Link>
                                        <button className="header-bottom__bar tp-menu-bar d-lg-none" onClick={() => setSidebarOpen(true)} aria-label="Open Menu">
